...
Se l’utente invia riferimenti visivi: usa **Read** sul percorso file immagine (PNG/JPG) indicato nel messaggio. In CLI non esiste l’allegato immagini come in Cursor. Vedi `GEMINI.md` in root.
model: sonnet
---
